...
public class ConsumerHelloWorld {
    static final String QUEUE_NAME = "hello_world";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         * 参数5：队列其它参数
         */
        channel.queueDeclare(ConsumerHelloWorld.QUEUE_NAME, true, false, false, null);
         ...
         * 参数3：消息接收到后回调
         */
        channel.basicConsume(ConsumerHelloWorld.QUEUE_NAME, true, consumer);
